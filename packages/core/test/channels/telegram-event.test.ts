...
describe("parseTelegramUpdate", () => {
  it("extracts a plain message update", () => {
    ...
    ).toEqual({ kind: "message", event: { chatId: "12345", messageThreadId: undefined, messageId: 42, text: "hello" } });
  });
  ...
  it("carries message_thread_id through for a forum-topic message", () => {
    ...
    expect(result).toEqual({ kind: "message", event: { chatId: "-100123", messageThreadId: 5, messageId: 42, text: "hi" } });
  });
